...
const ChooseCategories: FC<ChooseCategoriesProps> = ({ Component, title, bg = "#fff", imgURL, textColor = "black", active = false }) => {
    return (
        <div style={{ background: `${active ? '#DB4444' : bg }`}} className={`rounded-md border-2 border-black/10 flex flex-col justify-center items-center cursor-pointer h-[11rem] w-[11rem]`}>
